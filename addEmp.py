...
def buildFrame () :
    ...
    root.title("POS - Add New Employee")
    ...
    lbl = Label(root, text = "Please fill out the details below: ", font=("Helvetica", 26))
    lbl.pack(fill = X, pady = 10);
    frame2 = Frame(root)
...
# link function to change dropdown
    ...
    submit_button = Button(frame2, image=login_image, command = add_record)
